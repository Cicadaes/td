...
export class LimitNumberInputDirective {
  ...
  public static POSITIVE_FLOATING_POINT: RegExp = /^(([0-9]+\.[0-9]*[1-9][0-9]*)|([0-9]*[1-9][0-9]*\.[0-9]+)|([1-9][0-9]*))$/;
  // 正浮点数 PFP
  // tslint:disable-next-line
  public static NEGATIVE_FLOATING_POINT: RegExp = /^(-(([0-9]+\.[0-9]*[1-9][0-9]*)|([0-9]*[1-9][0-9]*\.[0-9]+)|([0-9]*[1-9][0-9]*)))$/;
