...
@NgModule({
  ...
  declarations: [LimitInputTextDirective, LimitNumberInputDirective, LimitTextareaTextDirective],
  exports: [LimitInputTextDirective, LimitNumberInputDirective, LimitTextareaTextDirective]
})
