import { Component, Input, Output, OnInit, OnChanges, EventEmitter, SimpleChanges, Injector } from '@angular/core';
...
export class AdvancedTransFunnelAddFormComponent extends BaseComponent implements OnInit, OnChanges {
  ...
  constructor(private fb: FormBuilder, private service: AdvancedTransFunnelService, private injector: Injector) {
    super(injector);
  ...
  onBackFunnelSteps(value: any) {
    //  this._steps = value;
    setTimeout(() => {
      this.componentChange(value, 'steps');
      this._submitForm();
