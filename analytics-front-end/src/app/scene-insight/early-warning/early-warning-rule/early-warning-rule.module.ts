...
@NgModule({
  imports: [CommonModule, FormsModule, RouterModule.forChild(appRoutes), NgZorroAntdModule, TabListModule],
  declarations: [EarlyWarningRuleComponent, BusinessRuleDefinitionComponent, MktRuleDefinitionComponent]
})
