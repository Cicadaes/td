...
export class RejectDialogComponent extends BaseComponent implements OnInit, OnChanges {
  ...
  constructor(private processManageService: ProcessManageService, private injector: Injector, private fb: FormBuilder) {
    super(injector);
  }
  ...
  save() {
    ...
    this.globals.resetBodyStyle();
    this.processManageService.insertReason(obj).subscribe(
      response => {
