...
export class TagCreateService extends CurdService {
  ...
  // 查询属性备选列表
  metaAttributeList() {
    const configUrl: any = `${this.crowdApiBaseUrl}/meta/metaAttribute/listDetails/${this.getProductId()}`;
  ...
  getEvent2(parentId, searchValue) {
    let url = '/crowd/admin/dic/event/item?page=1&rows=111111&dicItemKey=eventid&eventTypeId=';
