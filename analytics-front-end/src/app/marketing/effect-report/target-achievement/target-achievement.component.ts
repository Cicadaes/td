...
export class TargetAchievementComponent extends BaseComponent implements OnInit, OnChanges {
  ...
  constructor(private targetAchievementService: TargetAchievementService, private injector: Injector) {
    super(injector);
  }
  ...
  private getTrend() {
    ...
    this.targetAchievementService
      .getTrend(this.campaignId, segmentIdArr, this.targetIdCurrent)
  ...
  downloadTrend() {
    this.targetAchievementService
      .downloadTrend(this.campaignId, this.campaignName, this.compareChooseIds, this.targetIdCurrent)
      .subscribe(() => {});
  }

  downloadDetail() {
    this.targetAchievementService
      .downloadDetail(this.campaignId, this.campaignName, this.compareChooseIds)
      .subscribe(() => {});
  }
