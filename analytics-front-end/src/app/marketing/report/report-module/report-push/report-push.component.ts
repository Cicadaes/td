    ...
    for (const i in data) {
      if (data.hasOwnProperty(i)) {
        ...
        const json = {
          ...
          sum_td_app_recv_count_rate:
            ((data[i].sum_td_app_recv_count / data[i].sum_td_app_send_count) * 100 || 0).toFixed(2) + '%',
          sum_td_app_display_count: data[i].sum_td_app_display_count.toLocaleString(),
          sum_td_app_display_count_rate:
            ((data[i].sum_td_app_display_count / data[i].sum_td_app_recv_count) * 100 || 0).toFixed(2) + '%',
          sum_td_app_click_count: data[i].sum_td_app_click_count.toLocaleString(),
          sum_td_app_click_count_rate:
            ((data[i].sum_td_app_click_count / data[i].sum_td_app_recv_count) * 100 || 0).toFixed(2) + '%'
        };
