...
export class ActivityCenterService extends CurdService {
  ...
  checkCampaignNameUnique(name: any) {
    const url = `/marketing-api/campaign/campaigns/checkCampaignNameUnique/${this.getProductId()}`;
    const configUrl: any = `${url}?campaignName=${name}`;
  ...
  updateCampaigns(body: any) {
    ...
    return this.http.put(configUrl, body).pipe(catchError(this.handleError));
  }

  // /marketing-api/campaign/campaigns/clone/${campaignId} 多触点克隆
  manyDotClon(campaignId: any) {
    return this.http.get(`/marketing-api/campaign/campaigns/clone/${campaignId}`).pipe(catchError(this.handleError));
  }

  // /marketing-api/campaign/segments/clone/${campaignId} 单触点克隆
  oneDotClon(segmentId: any) {
    return this.http.get(`/marketing-api/campaign/segments/clone/${segmentId}`).pipe(catchError(this.handleError));
  }

  // /marketing-api/campaign/segments/${campaignId} 获取投放列表
  getSegmentList(campaignId: any) {
    return this.http.post(`/marketing-api/campaign/segments/${campaignId}`, {}).pipe(catchError(this.handleError));
  }

  // marketing-api/campaign/campaigns 新建多触点
  insertManyDot(parmas: any) {
    return this.http.post(`/marketing-api/campaign/campaigns`, parmas).pipe(catchError(this.handleError));
  }

  // marketing-api/campaign/campaigns/clone 多触点克隆新建
  insertManyDotClon(parmas: any) {
    return this.http.post(`/marketing-api/campaign/campaigns/clone`, parmas).pipe(catchError(this.handleError));
  }
  ...
  getConfigByChannelType(type: any) {
    return this.http
      .get(`/marketing-api/config/channelConfigs/byChannelType/${type}`)
  ...
  saveSingleSegment(data: any) {
    return this.http
      .post(`/marketing-api/campaign/segments/create/${this.getProductId()}`, data)
      .pipe(catchError(this.handleError));
  }
  ...
  updateSingleSegment(data: any) {
    return this.http
      .put(`/marketing-api/campaign/segments/update/${this.getProductId()}`, data)
      .pipe(catchError(this.handleError));
  }

  // 获取dw链接前缀
  getDwUrlPrefix() {
    return this.http.get(`/marketing-api/campaign/campaigns/dwserver`).pipe(catchError(this.handleError));
  }
  ...
  setContentDeleteTrue(id: any) {
    return this.http.delete(`/marketing-api/campaign/campaigns/${id}`).pipe(catchError(this.handleError));
  }
