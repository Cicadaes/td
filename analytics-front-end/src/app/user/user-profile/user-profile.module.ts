...
@NgModule({
  imports: [CommonModule, FormsModule, NgZorroAntdModule, ChartModule, UserProfileRoutingModule],
  declarations: [UserProfileComponent, BaseInfoComponent, IndexAnalysisComponent, BehaviorTrajectoryComponent]
})
