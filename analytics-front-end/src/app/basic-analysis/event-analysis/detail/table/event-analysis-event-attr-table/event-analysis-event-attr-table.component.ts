...
@Component({
  selector: 'app-event-analysis-event-attr-table',
  templateUrl: './event-analysis-event-attr-table.component.html',
  styleUrls: ['./event-analysis-event-attr-table.component.less'],
  providers: [EventAnalysisService]
})
export class EventAnalysisEventAttrTableComponent extends BaseComponent implements OnInit {
  ...
  searchData(reset: boolean = false): void {
    ...
    this.service.getEventAttrs(param).subscribe((response: any) => {
      this.loading = false;
