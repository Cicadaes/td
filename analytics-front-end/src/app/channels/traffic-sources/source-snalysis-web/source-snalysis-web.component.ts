...
@Component({
  selector: 'app-source-snalysis-web',
  templateUrl: './source-snalysis-web.component.html',
  styleUrls: ['./../traffic-sources.component.less']
})
export class SourceSnalysiswebComponent extends BaseComponent implements OnInit {
