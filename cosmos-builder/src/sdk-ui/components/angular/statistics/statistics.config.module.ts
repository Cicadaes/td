...
import { StatisticsStyleComponent } from './statistics-style/statistics-style.component';
...
@NgModule({
    ...
    entryComponents: [StatisticsStyleComponent,StatisticsDataComponent],
    providers: [ReportConfigService]
})
export default class StatisticsConfigModule{
