...
import { TableProcedureService } from './table-style-content.service';
...
@Component({
    ...
    templateUrl: './table-style-content.component.html',
    styleUrls: ['./table-style-content.component.less'],
...
export class TableContentComponent implements OnInit {
    ...
    saveTheDataSource(val: any) {
        ...
        if (table[0].name == "") {
            ...
            if (!this.resultarr) {
                this.TableProcedureService.SAVE(this.databases)
                this.decide = false;
