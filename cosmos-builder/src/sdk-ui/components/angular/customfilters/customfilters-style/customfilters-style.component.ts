...
@Component({
    templateUrl: './customfilters-style.component.html',
    styleUrls: ['./customfilters-style.component.less'],
})

export class customfiltersStyleComponent extends StylePanel implements OnInit {
    way: any = 'show';
