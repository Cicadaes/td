...
@Component({
    templateUrl: './retention-style.component.html',
    styleUrls: ['./retention-style.component.less'],
})

export class RetentionStyleComponent extends StylePanel implements OnInit {
    ...
    OptionChange(event?: Event) {
        ...
        let data = { heatmap:this.heatmap,content: this.content,height:{adapt:true},layout: this.layoutStyle};
