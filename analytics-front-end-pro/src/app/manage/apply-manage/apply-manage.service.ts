...
export class ApplyManageService extends CurdService {
    ...
    getAppConfig() {
        return this.http.get(`/marketing-api/config/appConfigs/${this.productId}`).pipe(
    ...
    updateAndroidPush(params: any) {
        return this.http.patch('/marketing-api/config/appConfigs/thirdchannel/config', params).pipe(
            catchError(this.handleError)
        );
    }
    ...
    updateIOS(params: any, appId: any, proId: any) {
        return this.http.post(`/marketing-api/config/appConfigs/pem/upload/${appId}/${proId}`, params
        ).pipe(
            catchError(this.handleError)
        );
    }
    ...
    deleteAndroidPush(appId: any, channel: any) {
        return this.http.patch(`/marketing-api/config/appConfigs/${appId}/${channel}`, {}).pipe(
            catchError(this.handleError)
        );
    }
    ...
    getChannelConfig(params: any) {
        ...
        return this.http.get(`/marketing-api/config/channelConfigs` + stringParams).pipe(
            catchError(this.handleError)
        );
    }
    ...
    insertChannelConfig(params: any) {
        return this.http.post(`/marketing-api/config/channelConfigs`, params).pipe(
            catchError(this.handleError)
        );
    }
    ...
    updateChannelConfig(params: any) {
        return this.http.put(`/marketing-api/config/channelConfigs`, params).pipe(
            catchError(this.handleError)
        );
    }
    ...
    deleteChannelConfig(id: any) {
        return this.http.delete(`/marketing-api/config/channelConfigs/${id}`).pipe(
            catchError(this.handleError)
        );
    }
}
