...
@Component({
    ...
    styleUrls: ['./warning-rule.component.less']
})

export class WarningRuleComponent extends BaseComponent implements OnInit {
    tableData: any;
    pageIndex = 1;
    total = 0;
    pageSize = 10;
    ...
    constructor(
        private service: EarlyWarningService,
    ...
    refreshData(reset = false) {
        ...
        this.tableData = [
            {
                alarmName: '规则名称',
                alarmType: 1, updateTime: '2018-12-20 00:00:00', creator: '李欣', effectStatus: 0, description: '欧洲杯期间两个月时间进行活动宣传推广促动'
            },
            {
                alarmName: '规则名称1',
                alarmType: 2, updateTime: '2018-12-20 00:00:00', creator: '李欣',
                effectStatus: 1,
                description: '欧洲杯期间两个欧洲杯期间两个月时间进行活动宣传推广促动欧洲杯期间两个月时间进行活动宣传推广促动欧洲杯期间两个月时间进行活动宣传推广促动欧洲杯期间两个月时间进行活动宣传推广促动月时间进行活动宣传推广促动'
            },
            {
                alarmName: '规则名称1',
                alarmType: 2, updateTime: '2018-12-20 00:00:00', creator: '李欣', effectStatus: 2, description: '欧洲杯期间两个月时间进行活动宣传推广促动'
            },
            {
                alarmName: '规则名称1',
                alarmType: 2, updateTime: '2018-12-20 00:00:00', creator: '李欣', effectStatus: 3, description: '欧洲杯期间两个月时间进行活动宣传推广促动'
            }
        ];
