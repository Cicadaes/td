...
compute(){
        ...
        echo
    java -classpath .:$basedir/../libs/*  com.talkingdata.wifianalytics.offline.compute.main.JobMain ${jobname} ${date} ${dateinterval} ${tenantid} ${projectid} ${placeid} ${sensorid} ${roomid}
