...
package it.uniroma3.mat.extendedset.rev157.intset;


import it.uniroma3.mat.extendedset.rev157.utilities.BitCount;
...
public class ConciseSet extends AbstractIntSet implements java.io.Serializable {
	...
	public String debugInfo() {
		...
		try {
		    f = new Formatter(s, Locale.ENGLISH);
            f.format("Elements: %s\n", toString());
    ...
    public void setWords(int[] input){
    	words = input;
    }
