...
package it.uniroma3.mat.extendedset.rev157.test;

//import it.uniroma3.mat.extendedset.intset.Concise2Set;

import it.uniroma3.mat.extendedset.rev157.ExtendedSet;
import it.uniroma3.mat.extendedset.rev157.ExtendedSet.ExtendedIterator;
import it.uniroma3.mat.extendedset.rev157.intset.*;
import it.uniroma3.mat.extendedset.rev157.utilities.IntSetStatistics;
import it.uniroma3.mat.extendedset.rev157.utilities.random.MersenneTwister;
import it.uniroma3.mat.extendedset.rev157.wrappers.GenericExtendedSet;
import it.uniroma3.mat.extendedset.rev157.wrappers.IndexedSet;
import it.uniroma3.mat.extendedset.rev157.wrappers.IntegerSet;
import it.uniroma3.mat.extendedset.rev157.wrappers.matrix.BinaryMatrix;
import it.uniroma3.mat.extendedset.rev157.wrappers.matrix.BinaryMatrix.CellIterator;
...
public class Debug {
	...
	private static <T> boolean checkContent(ExtendedSet<T> bits, SortedSet<T> items) {
		...
		if (!bits.last().equals(items.last()))
			return false;
        return bits.first().equals(items.first());
    }
