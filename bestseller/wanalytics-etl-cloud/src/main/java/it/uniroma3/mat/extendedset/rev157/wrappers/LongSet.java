...
package it.uniroma3.mat.extendedset.rev157.wrappers;
...
import it.uniroma3.mat.extendedset.rev157.intset.IntSet.IntIterator;
...
public class LongSet implements Cloneable, Comparable<LongSet>, java.io.Serializable, Iterable<Long> {
	 ...
	 *
	 * @param block
	 *            {@link IntSet} instance internally used to represent
	 ...
	 *
	 * @param other
	 *            {@link LongSet} instance that represents the right
	 *            operand
	 ...
	 *
	 * @param other
	 *            {@link LongSet} to intersect with
	 ...
	 *
	 * @param other
	 *            {@link LongSet} instance to intersect with
	 * @param minElements
