...
package it.uniroma3.mat.extendedset.rev157;


import it.uniroma3.mat.extendedset.rev157.intset.ArraySet;
...
import it.uniroma3.mat.extendedset.rev157.wrappers.LongSet;
import it.uniroma3.mat.extendedset.rev157.wrappers.matrix.PairSet;
...
public interface ExtendedSet<T> extends SortedSet<T>, Cloneable, Comparable<ExtendedSet<T>> {
	 ...
	 */
    boolean containsAtLeast(Collection<? extends T> other, int minElements);
	 ...
	 *            the type of elements maintained by this set
	 */
    interface ExtendedIterator<X> extends Iterator<X> {
		/**
	 ...
	 */
    List<? extends ExtendedSet<T>> powerSet(int min, int max);
