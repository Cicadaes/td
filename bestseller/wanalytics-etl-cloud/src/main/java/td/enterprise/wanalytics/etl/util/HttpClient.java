...
//	private static String contentType = "application/json";
    ...
    public static <T> T post(String path, Object body, Header[] headers, Class<T> returnClazz) throws IOException, BusinessException {
...
//	}
	...
	@SuppressWarnings("unchecked")
	public static String getHTML(String host, String path) {		
		path = host + path;
		log.info("url path = " + path);
		HttpParams params = new BasicHttpParams();
		params.setParameter("charset", encode);
	...
	public static List get_list(String path, Class elementClass) throws BusinessException, IOException {
		path = host + path;
