...
public class MailUtil {
	...
	public static String address = HttpUtil.getParamFromConfigServer("mail.smtp.from");
	public static String password = HttpUtil.getParamFromConfigServer("mail.smtp.password");
	public static String host = HttpUtil.getParamFromConfigServer("mail.smtp.host");
	public static String port = HttpUtil.getParamFromConfigServer("mail.smtp.port");
	public static String auth = HttpUtil.getParamFromConfigServer("mail.smtp.auth");
	public static String starttls = HttpUtil.getParamFromConfigServer("mail.smtp.starttls.enable");
	public static String name = HttpUtil.getParamFromConfigServer("mail.name");
	public static String transType = HttpUtil.getParamFromConfigServer("mail.transport");
