(function (w) {
    ...
    var RenderDom = {
        createFrame: function (example) {
            var html = '<div class="TD_WeekPicke">' ;
            html += this.header(example);
//                '<div class="TD_WeekPicke_header"><i class="TD_WeekPicke_pre" target-type="pre">pre</i><span target-type="TD_WeekPicke_week"></span></div>' +
         ...
         header: function (example) {
                    ...
                    html += '<span>' + example.o.month + '</span>'
        ...
        renderCon: function (example) {
            var year = example.o.month.substring(0, 4),
                month = example.o.month.substring(5, 7);
        ...
        reloadHTML: function (myThis) {
            ...
            for(var i = 0; i< number; i++){
               ...
               startMonth = startMonth < 10 ? "0"+startMonth : startMonth;
                ...
                myThis.$html = $(RenderDom.createFrame(myThis));
            ...
            var h1 = $(".TD_WeekPicke_content").eq(0).height(),
                ...
                if(h1 > h2){
                    $(".TD_WeekPicke_content").eq(1).append("<li class='disable'></li>")
                }else if(h1 < h2){
                     $(".TD_WeekPicke_content").eq(0).append("<li class='disable'></li>")
                }
