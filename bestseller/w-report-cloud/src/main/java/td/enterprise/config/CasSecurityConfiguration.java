...
import td.enterprise.security.*;
import td.enterprise.security.cas.*;

import javax.inject.Inject;

@Configuration
@EnableWebSecurity
@Profile(Constants.SPRING_PROFILE_SSO)
public class CasSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    @Inject
    private AjaxCasAuthenticationSuccessHandler ajaxCasAuthenticationSuccessHandler;
    ...
    public CasAuthenticationFilter casAuthenticationFilter() throws Exception {
        ...
        casAuthenticationFilter.setAuthenticationSuccessHandler(ajaxCasAuthenticationSuccessHandler);
