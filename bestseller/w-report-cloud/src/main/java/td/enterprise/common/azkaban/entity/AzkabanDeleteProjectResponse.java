...
public class AzkabanDeleteProjectResponse extends AzkabanResponse {
    ...
    public String toString() {
        return "AzkabanDeleteProjectResponse [failure()=" + failure() + ", error()=" + error() + ", getMessage()=" + getMessage() + ", getStatus()=" + getStatus()
