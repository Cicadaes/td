...
import com.talkingdata.analytics.wifi.collector.util.OfflineJsonDataParser;
...
public class DataBeanTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        JsonData jsonData = objectMapper.readValue("{\"data\":[\"AQAAbAAA5JVuT/DsTmkVoQAAAAvDAXifcNryJrgCaF1" +
                ...
                "ts\":1,\"version\":\"1.1\",\"datatype\":\"rssi\"}",JsonData.class);
        OfflineJsonDataParser parser = new OfflineJsonDataParser();
        for (WiFiDataEntity wiFiDataEntity : parser.standard(jsonData)) {
            System.out.println(wiFiDataEntity);
        }
    }
}
