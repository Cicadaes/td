...
public class Utils implements Serializable {
	...
	public static String toLog(Object... message) {
		return td.enterprise.wanalytics.processor.utils.StringUtils.arrayToString(message);
	}
	...
	public static String toLog(Exception e, Object... message) {
		return td.enterprise.wanalytics.processor.utils.StringUtils.arrayToString(message, toLog(e));
	}
