...
public class Utils implements Serializable {
	 ...
	 * For example <br>
	 * A and B and C <br>
	 * If A and B and C are not as null, then isNotNull (A, B, C) returns true,
	 ...
	 * If Long, Integer, Double, Float, Byte, Short Is null or equal to 0 to
	 * true. *
	 * 
	 * @param t
	 *            the t
	 ...
	 * For example <br>
	 * A and B and C <br>
	 * If A and B and C are not as empty, then isNotEmpty (A, B, C) returns
	...
	public static String toLog(Exception e, Object... message) {
		return StringUtils.arrayToString(message, e);
	}

	/**
	 * return e == null ? "异常为空" : "信息:" + e.getMessage() + "堆栈:" +
