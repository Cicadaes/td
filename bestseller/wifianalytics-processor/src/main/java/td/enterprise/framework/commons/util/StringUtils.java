...
public class StringUtils extends org.apache.commons.lang.StringUtils {
     ...
     * English: <br>
     * If the original string is empty, return an empty StringBuffer, or delete
     * the last one you want to delete the string.
     *
     * @param rawString    原始的字符串
     * @param removeString 要删除的最后一个字符串
     ...
     * English: <br>
     * If the original string is empty, return an empty StringBuffer, or add a
     * string to be added.
     *
     * @param rawString 原始的字符串
     * @param addString 要添加一个字符串
    ...
    public static boolean stringToBool(String booleanValue, boolean defaultValue) {
        try {
            ...
            logger.warn(Utils.toLog("stringToBool失败,booleanValue是", booleanValue));
        }
        return defaultValue;
    }
     ...
     * English: <br>
     * If there are multiple string concatenation, use this method to improve
     * efficiency.
     *
    ...
    public static String stringSubByLength(String str, int length, int lastReplaceLength, String lastReplace) {
        return str == null ? str : str.length() <= length ? str : str.substring(0, length - lastReplaceLength) + lastReplace;
    }

    public static String stringSubByLength(String str, int length) {
        return str == null ? str : str.length() <= length ? str : str.substring(0, length - 3) + "...";
    }
