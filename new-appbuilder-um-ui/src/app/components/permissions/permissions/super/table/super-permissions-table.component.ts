...
import { ScrollToTopService } from '../../../../../@themes/scroll-service/scrollto-top.service';

@Component({
  selector: 'super-permissions-table',
  templateUrl: './super-permissions-table.component.html',
  styleUrls: ['./super-permissions-table.component.css']
})

export class SuperPermissionsTableComponent implements OnInit, OnChanges {
  ...
  constructor(private scrollSer: ScrollToTopService, private service: permissionsService) {
  }
