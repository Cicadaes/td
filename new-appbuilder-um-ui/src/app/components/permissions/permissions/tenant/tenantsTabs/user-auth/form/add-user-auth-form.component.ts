...
@Component({
    selector: 'add-user-auth-form',
    templateUrl: './add-user-auth-form.component.html',
    styleUrls: ['./add-user-auth-form.component.css'],
    providers: [ FormBuilder]
})

export class AddUserAuthFormComponent implements OnInit{
