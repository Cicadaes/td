...
@Injectable()
export class EditTenantLicenceService extends CRUDService{
    ...
    getTenantLicenceAttributeUrl:string = window['appConfig']['apiCode']+'/tenantLicenceController/getUpdateTenantLicenceAttributeList';
