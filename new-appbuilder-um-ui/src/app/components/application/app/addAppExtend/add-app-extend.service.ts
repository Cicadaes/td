...
@Injectable()
export class AddAppExtendService {
    getAppAttributeUrl: string = window['appConfig']['apiCode'] + '/appController/getAppExtendAttributeByApp';
    deleteAppAttributeUrl: string = window['appConfig']['apiCode'] + '/appController/deleteAppAttribute';
    getAppExtendAttributeByApp(params: any) {
