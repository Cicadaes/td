...
@Component({
  selector: 'edit-app-attribute-dialog',
  templateUrl: './edit-app-attribute-dialog.component.html',
  providers: [FormBuilder]
})
export class EditAppAttributeDialogComponent implements OnInit {
  ...
  @Output() onReloadAttr = new EventEmitter<any>();
  //appAttribute: any = [];
  code: string = ""
  name: string = ""
  defaultValue: string = ""
  ...
  constructor(private route: ActivatedRoute, private regService: RegexpSService, private fb: FormBuilder, private service: EditAppAttributeDialogService) {
