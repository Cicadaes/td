...
export class AdvancedTransFunnelService extends CurdService {
    ...
    queryChildEvents(params: any) {
        ...
        const url = this.reportBaseUrl + '/behaviorAnalysis/dictionarys/' + this.productId + str;
        return this.http.get(url);
    }

    queryEventTypes() {
        const url = this.reportBaseUrl + '/behaviorAnalysis/dictionarys/' + this.productId + '?dicKey=eventtype&order=asc';
        return this.http.get(url);
    }
    ...
    getEventList(params: any) {
        let url = `${this.reportBaseUrl}/behaviorAnalysis/dictionarys/${this.productId}`;
    ...
    getProvince() {
        const url = `${this.reportBaseUrl}/behaviorAnalysis/profilemetas/${this.productId}?displayType=Tag&showAll=true&shieldEvent=true&sort=dic_item_alias&order=asc`;
        return this.http.get(url).pipe(
            catchError(this.handleError)
        );
    }
    ...
    getProfilemetasList(eventId: number) {
        const url = `${this.reportBaseUrl}/behaviorAnalysis/profilemetas/${this.productId}?eventId=${eventId}&shieldEvent=true`;
        return this.http.get(url).pipe(
            catchError(this.handleError)
        );
    }
    ...
    getProfilemetasEventList() {
        const url = `${this.reportBaseUrl}/behaviorAnalysis/dictionarys/${this.productId}?dicKey=eventid`;
        return this.http.get(url).pipe(
            catchError(this.handleError)
        );
    }
    ...
    queryUsers(params: any) {
        const url = this.reportBaseUrl + '/conversionFunnel/queryCrowdData';
        return this.http.post(url, params);
    }

    queryTableColumns() {
        const url = `${this.reportBaseUrl}/behaviorAnalysis/profilemetas/${this.productId}?shieldEvent=true`;
        return this.http.get(url);
    }

    saveCrowd(params: any) {
        const url = this.reportBaseUrl + '/conversionFunnel/saveCrowd';
        return this.http.post(url, params);
    }
