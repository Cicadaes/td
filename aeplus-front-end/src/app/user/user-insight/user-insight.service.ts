...
export class UserInsightService extends CurdService {
    ...
    getPortrait(params: any) {
        return this.http.post('/crowd/user/carbon/filter', params).pipe(
    ...
    checkCrowdName(params: any) {
        ...
        return this.http.get('/crowd/crowd/crowds/query/-1' + stringParams).pipe(
            catchError(this.handleError)
        );
    ...
    insertCrowdName(params: any) {
        ...
        return this.http.post('/crowd/crowd/crowds/realtime/create', params).pipe(
            catchError(this.handleError)
        );
    ...
    getThead() {
        return this.http.get(`/crowd/user/queryProductConfig/${this.productId}/2/9`).pipe(
            catchError(this.handleError)
        );
    }
    ...
    getTableData(params: any) {
        return this.http.post('/crowd/user/query/carbon/userProfile', params).pipe(
            catchError(this.handleError)
        );
    }
