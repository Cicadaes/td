...
export class UserInsightComponent extends BaseComponent implements OnInit, OnChanges {
    ...
    ngOnInit() {
        ...
        if (this.userInsightService.userInsight['userInsight'].length > 0 &&(this.userInsightService.userInsight['userInsight'][0].value || this.userInsightService.userInsight['userInsight'][0].value ===0)) {
            this.moreSearchFlag = true;
            this.boolFilters = this.userInsightService.userInsight['userInsight'];
        }

        if (this.userInsightService.userInsight.attribute['name']) {
        ...
        this.updateParmas(this.parmas, this.userInsightService.userInsight['userInsight']);
    ...
    updateParmas(parmas: any, boolFilters: any) {
        ...
        if (boolFilters.length > 0 && boolFilters[0].fieldName && (boolFilters[0].value || boolFilters[0].value === 0)
    ...
    queryDeatil() {
        ...
        for (let k = 0; k < this.boolFilters.length; k++) {
            ...
            if (
               ...
               (boolFilter.value && boolFilter.value.length === 0))
            ) {
    ...
    initialValidateForm() {
        return this.fb.group({
            name: [null, [Validators.required, Validators.maxLength(50), this.replaceName, this.checkName], this.checkNameRepeat], // 画像组名称
        });
    }
    ...
    search(value: any) {
        ...
        this.updateParmas(this.parmas, this.boolFilters);
        if (!(this.boolFilters.length > 0 && this.boolFilters[0].fieldName && this.boolFilters[0].value)) {
            if (this.parmas.hasOwnProperty('definition')) {
                delete this.parmas.definition;
            }
        }
    ...
    detail(item: any, event: Event) {
        ...
        let obj = {};
        obj = this.parmas;
        if (this.boolFilters.length > 0 && this.boolFilters[0].fieldName && this.boolFilters[0].value && this.parmas.definition) {
            const one = {
                operator: 'and'
            };
