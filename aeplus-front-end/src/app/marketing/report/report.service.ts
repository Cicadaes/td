...
export class ReportService extends CurdService {
    ...
    getContribute(segmentId: any, campaignId: any) {
        return this.http.get(`/marketing-api/report/pushReports/contribute/${campaignId}/${segmentId}`).pipe(
    ...
    getCampaign(campaignId: any) {
        return this.http.get(`/marketing-api/campaign/campaignTargets/campaignId/${campaignId}`).pipe(
            catchError(this.handleError)
        );
    }
    ...
    getOverview (segmentId: any, date: any) {
        return this.http.get(`/marketing-api/report/pushReports/overview/${segmentId}`).pipe(
            catchError(this.handleError)
        );
    }
    ...
    getTimeAxis(segmentId: any) {
        return this.http.get(`/marketing-api/report/pushReports/timeaxis/${segmentId}`).pipe(
            catchError(this.handleError)
        );
    }
    ...
    getTrend(segmentId: any) {
        return this.http.get(`/marketing-api/report/pushReports/trend/${segmentId}`).pipe(
            catchError(this.handleError)
        );
    }
    ...
    downLoadOver(productId: any, segmentId: any) {
        return this.http.get(`/marketing-api/report/pushReports/downloadOverviewReport/${segmentId}`).pipe(
            catchError(this.handleError)
        );
    }
    ...
    downLoadTrend(productId: any, segmentId: any) {
        return this.http.get(`/marketing-api/report/pushReports/downloadTrendReport/${segmentId}`).pipe(
            catchError(this.handleError)
        );
    }
    ...
    getEdmOverview (segmentId: any) {
        return this.http.get(`/marketing-api/report/edmReports/overview/${segmentId}`).pipe(
            catchError(this.handleError)
        );
    }
    ...
    getEdmTrend (segmentId: any, statDimension: any) {
        return this.http.get(`/marketing-api/report/edmReports/trend/${segmentId}?statDimension=${statDimension}`).pipe(
            catchError(this.handleError)
        );
    }
    ...
    downLoadEdmOver(segmentId: any) {
        return this.http.get(`/marketing-api/report/edmReports/downloadOverviewReport/${segmentId}`).pipe(
            catchError(this.handleError)
        );
    }
    ...
    downLoadEdmTrend(segmentId: any, statDimension: any) {
        return this.http.get(`/marketing-api/report/edmReports/downloadTrendReport/${segmentId}?statDimension=${statDimension}`).pipe(
            catchError(this.handleError)
        );
    }
    ...
    getSmsOverview (segmentId: any) {
        return this.http.get(`/marketing-api/report/smsReports/overview/${segmentId}`).pipe(
            catchError(this.handleError)
        );
    }
    ...
    getSmsTrend (segmentId: any, statDimension: any) {
        return this.http.get(`/marketing-api/report/smsReports/trend/${segmentId}?statDimension=${statDimension}`).pipe(
            catchError(this.handleError)
        );
    }
    ...
    downLoadSmsOver(segmentId: any) {
        return this.http.get(`/marketing-api/report/smsReports/downloadOverviewReport/${segmentId}`).pipe(
            catchError(this.handleError)
        );
    }
    ...
    downLoadSmsTrend(segmentId: any, statDimension: any) {
        return this.http.get(`/marketing-api/report/smsReports/downloadTrendReport/${segmentId}?statDimension=${statDimension}`).pipe(
            catchError(this.handleError)
        );
    }
}
