...
export class PipelineCommunicationService {
    ...
    greenIconMap: any = {
        'entrance': '/aeplus/assets/images/pipeline/component-entrance-green.svg',
        'hourMeter': '/aeplus/assets/images/pipeline/component-hourMeter-green.svg',
        'filter': '/aeplus/assets/images/pipeline/component-filter-green.svg',
        'generate': '/aeplus/assets/images/pipeline/component-generateCrowd-green.svg',
        'split': '/aeplus/assets/images/pipeline/component-split-green.svg',
        'trigger': '/aeplus/assets/images/pipeline/component-trigger-green.svg',
        'push': '/aeplus/assets/images/pipeline/component-push-green.svg',
        'shortMessage': '/aeplus/assets/images/pipeline/component-sms-green.svg',
        'mail': '/aeplus/assets/images/pipeline/component-edm-green.svg',
        'end': '/aeplus/assets/images/pipeline/component-end-green.svg',
    };

    redIconMap: any = {
        'entrance': '/aeplus/assets/images/pipeline/component-entrance-red.svg',
        'hourMeter': '/aeplus/assets/images/pipeline/component-hourMeter-red.svg',
        'filter': '/aeplus/assets/images/pipeline/component-filter-red.svg',
        'generate': '/aeplus/assets/images/pipeline/component-generateCrowd-red.svg',
        'split': '/aeplus/assets/images/pipeline/component-split-red.svg',
        'trigger': '/aeplus/assets/images/pipeline/component-trigger-red.svg',
        'push': '/aeplus/assets/images/pipeline/component-push-red.svg',
        'shortMessage': '/aeplus/assets/images/pipeline/component-sms-red.svg',
        'mail': '/aeplus/assets/images/pipeline/component-edm-red.svg',
        'end': '/aeplus/assets/images/pipeline/component-end-red.svg',
    };

    constructor(public utiles: Utiles,
    ...
    beforeSaveOrCheck(that: any) {
        ...
        let copyData = _.cloneDeep(that.pcs.nodeData);
    ...
    formatTrigger(data: any, that: any) {
        ...
        if (nodeData.targetType === 'event' && nodeData.eventList) {
            ...
            nodeData.targetList.forEach((data: any) => {
                if (data.code !== 'range') {
                    nodeData.mainExpression.push(`'${nodeData.otherTarget}' : '${data.code}' : ${data.number || 0} : == : '${data.name || undefined}'`);
                } else {
                    nodeData.mainExpression.push(`'${nodeData.otherTarget}' : range : ${data.first || 0}-${data.second || 0} : == : '${data.name || undefined}'`);
                }
            });
            ...
            nodeData.conditions.forEach((data: any) => {
                if (data && data.target !== 'undefined') {
                    if (data.code !== 'range' && data.number) {
                        ...
                        nodeData.additionExpression.push(`'${data.target}' : range : ${data.first || undefined}-${data.second || undefined}`);
