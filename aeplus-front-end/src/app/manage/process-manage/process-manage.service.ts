...
//    }
    ...
    insertReason(params: any) {
        return this.http.patch('/marketing-api/campaign/pipelines/rejectPipeline', params).pipe(
            catchError(this.handleError)
        );
    }
    ...
    approve(id: any) {
        return this.http.patch(`/marketing-api/campaign/pipelines/approvePipeline/${id}`, {}).pipe(
            catchError(this.handleError)
        );
    }
    ...
    downLine(id: any) {
        return this.http.patch(`/marketing-api/campaign/pipelines/offlinePipeline/${id}`, {}).pipe(
            catchError(this.handleError)
        );
    }
