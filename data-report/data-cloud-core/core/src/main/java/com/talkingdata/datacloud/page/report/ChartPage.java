...
/**
 * <b>功能：</b>TD_DC_CHART ChartPage<br>
...
public class ChartPage extends BasePage {
    ...
    public String getSnipeIdOperator() {
        return this.snipeIdOperator;
    }

    public void setSnipeIdOperator(String snipeIdOperator) {
        this.snipeIdOperator = snipeIdOperator;
    }
    ...
    public String getDatasetTypeOperator() {
        return this.datasetTypeOperator;
    }

    public void setDatasetTypeOperator(String datasetTypeOperator) {
        this.datasetTypeOperator = datasetTypeOperator;
    }
