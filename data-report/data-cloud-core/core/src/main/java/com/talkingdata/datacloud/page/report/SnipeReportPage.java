package com.talkingdata.datacloud.page.report;
...
/**
 * <b>功能：</b>TD_DC_SNIPE_REPORT SnipeReportPage<br>
 * <b>作者：</b>code generator<br>
 * <b>日期：</b> 2017-02-28 <br>
 * <b>版权所有：<b>Copyright(C) 2015, Beijing TendCloud Science & Technology Co., Ltd.<br>
 */
public class SnipeReportPage extends BasePage {

    private String id;
    private String idOperator = "=";
    private String reportUuid;
    private String reportUuidOperator = "=";
    private String title;
    private String titleOperator = "=";
    private String publishFlag;
    private String publishFlagOperator = "=";
    private String lockFlag;
    private String lockFlagOperator = "=";
    ...
    public String getReportUuidOperator() {
        return this.reportUuidOperator;
    }

    public void setReportUuidOperator(String reportUuidOperator) {
        this.reportUuidOperator = reportUuidOperator;
    }
    ...
    public String getPublishFlagOperator() {
        return this.publishFlagOperator;
    }

    public void setPublishFlagOperator(String publishFlagOperator) {
        this.publishFlagOperator = publishFlagOperator;
    }
    ...
    public String getLockFlagOperator() {
        return this.lockFlagOperator;
    }

    public void setLockFlagOperator(String lockFlagOperator) {
        this.lockFlagOperator = lockFlagOperator;
    }
