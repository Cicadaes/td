        ...
        return {
            ...
            link: function(scope, element, attrs) {
                ...
                function openColorPicker(e) {
                	$(document.getElementsByClassName('colorpicker-container')).css('display', 'none');
                ...
                function getColorpickerTemplatePosition (element) {
                    var
                        ...
                        templeWidth = parseInt(colorpickerTemplate.css('width')),
                        clientHeight = document.body.clientHeight,
                        templeHeight = parseInt(colorpickerTemplate.css('height'));
                    ...
                    if (clientWidth < positionValue.left  + templeWidth) {
                    	positionValue.left = clientWidth - templeWidth -2;
					} 
                    return {
