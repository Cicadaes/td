package com.talkingdata.datacloud.visual.logging;

import com.talkingdata.datacloud.visual.config.Constants;
...
public class LoggingAspect {
     ...
     */
    @Pointcut("within(com.talkingdata.datacloud.visual.controller.report.*)")
