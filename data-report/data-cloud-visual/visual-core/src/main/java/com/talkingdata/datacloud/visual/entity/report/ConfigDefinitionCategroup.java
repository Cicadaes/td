...
/**
 * <b>功能：</b>TD_DC_CONFIG_DEFINITION_CATEGROUP ConfigDefinitionCategroupEntity<br>
 * <b>作者：</b>code generator<br>
 * <b>日期：</b> 2017-06-26 <br>
 * <b>版权所有：<b>Copyright(C) 2015, Beijing TendCloud Science & Technology Co., Ltd.<br>
 */
@JsonIgnoreProperties({ "tenantId", "creator","createBy","createTime","updater","updateBy","updateTime" })
public class ConfigDefinitionCategroup extends BaseEntity {
     ...
     * <p>字段列表：</p>
     * <li>id -> id</li>
     * <li>groupOrderNum -> group_order_num</li>
    ...
    public static String fieldToColumn(String fieldName) {
        ...
        switch (fieldName) {
            case "id": return "id";
            case "groupOrderNum": return "group_order_num";
     ...
     * <p>字段列表：</p>
     * <li>id -> id</li>
     * <li>group_order_num -> groupOrderNum</li>
    ...
    public static String columnToField(String columnName) {
        ...
        switch (columnName) {
            case "id": return "id";
            case "group_order_num": return "groupOrderNum";
