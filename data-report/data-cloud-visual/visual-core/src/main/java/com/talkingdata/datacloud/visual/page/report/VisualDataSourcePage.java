...
/**
 * <b>功能：</b>TD_DC_VISUAL_DATA_SOURCE VisualDataSourcePage<br>
 * <b>作者：</b>code generator<br>
 * <b>日期：</b> 2017-03-15 <br>
 * <b>版权所有：<b>Copyright(C) 2015, Beijing TendCloud Science & Technology Co., Ltd.<br>
 */
public class VisualDataSourcePage extends BasePage {

    private String id;
    private String idOperator = "=";
    private String dataSourceDefinitionId;
    private String dataSourceDefinitionIdOperator = "=";
    ...
    public String getDataSourceDefinitionId() {
        return this.dataSourceDefinitionId;
    }

    public void setDataSourceDefinitionId(String dataSourceDefinitionId) {
        this.dataSourceDefinitionId = dataSourceDefinitionId;
    }

    public String getDataSourceDefinitionIdOperator() {
        return this.dataSourceDefinitionIdOperator;
    }

    public void setDataSourceDefinitionIdOperator(String dataSourceDefinitionIdOperator) {
        this.dataSourceDefinitionIdOperator = dataSourceDefinitionIdOperator;
    }
