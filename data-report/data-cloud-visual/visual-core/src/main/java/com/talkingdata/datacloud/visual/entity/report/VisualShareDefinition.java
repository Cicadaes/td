...
/**
 * <b>功能：</b>TD_DC_VISUAL_SHARE_DEFINITION VisualShareDefinitionEntity<br>
 * <b>作者：</b>code generator<br>
 * <b>日期：</b> 2017-03-15 <br>
 * <b>版权所有：<b>Copyright(C) 2015, Beijing TendCloud Science & Technology Co., Ltd.<br>
 */
public class VisualShareDefinition extends BaseEntity {
    ...
    public static String fieldToColumn(String fieldName) {
        ...
        switch (fieldName) {
            ...
            case "roleCode": return "role_code";
    ...
    public static String columnToField(String columnName) {
        ...
        switch (columnName) {
            ...
            case "role_code": return "roleCode";
    ...
    /** 引用ID，根据type值确定是Report、Page、Chart的ID **/
