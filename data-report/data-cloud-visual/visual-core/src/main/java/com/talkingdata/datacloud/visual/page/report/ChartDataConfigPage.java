...
/**
 * <b>功能：</b>TD_DC_VISUAL_CHART_DATA_CONFIG ChartDataConfigPage<br>
 * <b>作者：</b>code generator<br>
 * <b>日期：</b> 2017-04-14 <br>
 * <b>版权所有：<b>Copyright(C) 2015, Beijing TendCloud Science & Technology Co., Ltd.<br>
 */
public class ChartDataConfigPage extends BasePage {
    ...
    private String configDefinitionIdOperator = "=";
    ...
    private String chartTypeOperator = "=";
    private Integer dataSourceID;
    private String dataSourceIDOperator="=";
    ...
    public String getConfigDefinitionId() {
        return this.configDefinitionId;
    }

    public void setConfigDefinitionId(String configDefinitionId) {
        this.configDefinitionId = configDefinitionId;
    }

    public String getConfigDefinitionIdOperator() {
        return this.configDefinitionIdOperator;
    }

    public void setConfigDefinitionIdOperator(String configDefinitionIdOperator) {
        this.configDefinitionIdOperator = configDefinitionIdOperator;
    }
    ...
    public String getChartTypeOperator() {
        return chartTypeOperator;
    }

    public void setChartTypeOperator(String chartTypeOperator) {
        this.chartTypeOperator = chartTypeOperator;
    }
    ...
    public String getDataSourceIDOperator() {
        return dataSourceIDOperator;
    }

    public void setDataSourceIDOperator(String dataSourceIDOperator) {
        this.dataSourceIDOperator = dataSourceIDOperator;
    }
}
