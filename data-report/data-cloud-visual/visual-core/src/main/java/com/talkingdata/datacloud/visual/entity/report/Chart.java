...
/**
 * <b>功能：</b>TD_DC_VISUAL_CHART ChartEntity<br>
...
public class Chart extends BaseEntity {
    ...
    private ChartStyleConfig chartStyleConfig;
    private ChartDataConfig chartDataConfig;
    ...
    public void setChartStyleConfig(ChartStyleConfig chartStyleConfig) {
        this.chartStyleConfig = chartStyleConfig;
    }

    public ChartDataConfig getChartDataConfig() {
        return chartDataConfig;
    }

    public void setChartDataConfig(ChartDataConfig chartDataConfig) {
