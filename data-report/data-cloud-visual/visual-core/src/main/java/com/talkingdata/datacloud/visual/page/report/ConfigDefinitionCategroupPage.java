...
/**
 * <b>功能：</b>TD_DC_CONFIG_DEFINITION_CATEGROUP ConfigDefinitionCategroupPage<br>
 * <b>作者：</b>code generator<br>
 * <b>日期：</b> 2017-06-26 <br>
 * <b>版权所有：<b>Copyright(C) 2015, Beijing TendCloud Science & Technology Co., Ltd.<br>
 */
public class ConfigDefinitionCategroupPage extends BasePage {

    private String id;
    private String idOperator = "=";
    private String groupOrderNum;
    private String groupOrderNumOperator = "=";
    private String groupName;
    private String groupNameOperator = "=";
    ...
    public String getGroupOrderNumOperator() {
        return this.groupOrderNumOperator;
    }

    public void setGroupOrderNumOperator(String groupOrderNumOperator) {
        this.groupOrderNumOperator = groupOrderNumOperator;
    }
    ...
    public String getGroupNameOperator() {
        return this.groupNameOperator;
    }

    public void setGroupNameOperator(String groupNameOperator) {
        this.groupNameOperator = groupNameOperator;
    }
