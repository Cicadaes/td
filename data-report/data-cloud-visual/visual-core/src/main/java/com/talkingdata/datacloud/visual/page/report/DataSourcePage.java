...
/**
 * <b>功能：</b>TD_DC_VISUAL_DATA_SOURCE DataSourcePage<br>
...
public class DataSourcePage extends BasePage {
    ...
    private String dataSourceConnectionIdOperator = "=";
    private String mappedDataSource;
    private String mappedDataSourceOperator = "=";
    ...
    public String getDataSourceConnectionIdOperator() {
        return this.dataSourceConnectionIdOperator;
    }

    public void setDataSourceConnectionIdOperator(String dataSourceConnectionIdOperator) {
        this.dataSourceConnectionIdOperator = dataSourceConnectionIdOperator;
    }
    ...
    public String getMappedDataSourceOperator() {
        return this.mappedDataSourceOperator;
    }

    public void setMappedDataSourceOperator(String mappedDataSourceOperator) {
        this.mappedDataSourceOperator = mappedDataSourceOperator;
    }
