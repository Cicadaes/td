...
/**
 * <b>功能：</b>TD_DC_VISUAL_PAGE VisualPagePage<br>
 * <b>作者：</b>code generator<br>
 * <b>日期：</b> 2017-03-15 <br>
 * <b>版权所有：<b>Copyright(C) 2015, Beijing TendCloud Science & Technology Co., Ltd.<br>
 */
public class VisualPagePage extends BasePage {
    ...
    private String zIndexOperator = "=";
    private String backgroundColor;
    private String backgroundColorOperator = "=";
    private String backgroundImage;
    private String backgroundImageOperator = "=";
    private String isCustom;
    private String isCustomOperator = "=";
    private String width;
    private String widthOperator = "=";
    ...
    public String getZIndexOperator() {
        return this.zIndexOperator;
    }

    public void setZIndexOperator(String zIndexOperator) {
        this.zIndexOperator = zIndexOperator;
    }
    ...
    public String getBackgroundColorOperator() {
        return this.backgroundColorOperator;
    }

    public void setBackgroundColorOperator(String backgroundColorOperator) {
        this.backgroundColorOperator = backgroundColorOperator;
    }
    ...
    public String getBackgroundImageOperator() {
        return this.backgroundImageOperator;
    }

    public void setBackgroundImageOperator(String backgroundImageOperator) {
        this.backgroundImageOperator = backgroundImageOperator;
    }
    ...
    public String getIsCustomOperator() {
        return this.isCustomOperator;
    }

    public void setIsCustomOperator(String isCustomOperator) {
        this.isCustomOperator = isCustomOperator;
    }
    ...
    public void setWidthOperator(String widthOperator) {
    ...
    public String getHeightOperator() {
        return this.heightOperator;
    }

    public void setHeightOperator(String heightOperator) {
