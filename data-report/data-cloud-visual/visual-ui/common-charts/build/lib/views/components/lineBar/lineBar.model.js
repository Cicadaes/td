 ...
 */
var LineBarModel = (function (_super) {
    __extends(LineBarModel, _super);
    function LineBarModel() {
        var _this = _super.apply(this, arguments) || this;
        /** backgroundColor  */
        _this.backgroundColor = 'transparent';
        _this.color = ['#43A3FB', '#96D02F', '#FAA449', '#985FDE', '#ab47bc', '#00acc1', '#ff7043', '#9e9d24', '#5c6bc0', '#00838f', '#c4ccd3'];
        ...
        _this.yAxis_1_min = 0;
        _this.yAxis_1_max = 25;
        _this.yAxis_1_name = "percent";
        return _this;
    }
    return LineBarModel;
}(model_base_1.BaseModel));
exports.LineBarModel = LineBarModel;
//# sourceMappingURL=lineBar.model.js.map