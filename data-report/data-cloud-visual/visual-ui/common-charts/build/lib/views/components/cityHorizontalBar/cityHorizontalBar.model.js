 ...
 */
var CityHorizontalBarModel = (function (_super) {
    __extends(CityHorizontalBarModel, _super);
    function CityHorizontalBarModel() {
        var _this = _super.apply(this, arguments) || this;
        /** backgroundColor  */
        _this.backgroundColor = '#fff';
        _this.echart_color = ['#43A3FB', '#96D02F', '#F9D24A', '#985FDE', '#FAA449', '#1FCE6D'];
        /** title  */
        /** title 是否显示标题组件  */
        ...
        _this.xAxis_axisLine_show = false;
        /** xAxis  axisLine 坐标轴线线的颜色*/
        _this.xAxis_axisLine_lineStyle_color = '#DEE0E3';
        ...
        _this.xAxis_axisTick_lineStyle_color = "#5e6679";
        ...
        _this.xAxis_axisLabel_textStyle_color = "#DEE0E3";
        /** xAxis  label 文字的字体系列*/
        ...
        _this.xAxis_splitLine_lineStyle_color = '#DEE0E3';
        ...
        _this.yAxis_axisLine_lineStyle_color = '#DEE0E3';
        ...
        _this.yAxis_splitLine_lineStyle_color = '#5e6679';
    ...
    return CityHorizontalBarModel;
}(model_base_1.BaseModel));
exports.CityHorizontalBarModel = CityHorizontalBarModel;
//# sourceMappingURL=cityHorizontalBar.model.js.map