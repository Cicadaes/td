...
var TD_MonthPicke = require('./../calendar/month');
var TD_WeekPicke = require('./../calendar/week');
...
Operation = {
    init: function(myThis, isInner) {
        ...
        if (example.o.type == 'day') {
            $('.DatePicke_tool_shortcut a:eq(0)').click();
        } else if (example.o.type == 'week') {
            $('.DatePicke_tool_shortcut a:eq(2)').click();
        } else {
            $('.DatePicke_tool_shortcut a:eq(0)').click();
        }
