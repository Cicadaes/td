 ...
 */
var BarPieModel = (function (_super) {
    __extends(BarPieModel, _super);
    function BarPieModel() {
        var _this = _super.apply(this, arguments) || this;
        /** backgroundColor  */
        _this.backgroundColor = '#fff';
        _this.echart_color = ['#43A3FB', '#F9D24A', '#FAA449', '#43A3FB'];
        /** title  */
        /** title 是否显示标题组件  */
        ...
        _this.xAxis_axisLine_lineStyle_color = '#EBEEF2';
        ...
        _this.xAxis_axisTick_lineStyle_color = "#EBEEF2";
        ...
        _this.xAxis_axisLabel_textStyle_color = "#818596";
        /** xAxis  label 文字的字体系列*/
        ...
        _this.xAxis_splitLine_lineStyle_color = ['#EBEEF2'];
        ...
        _this.yAxis_name = "";
        _this.yAxis_nameLocation = "center";
        ...
        _this.yAxis_axisLabel_align = 'left';
        /** yAxis  label 刻度标签文字的颜色*/
        _this.yAxis_axisLabel_textStyle_color = "#404560";
        /** yAxis  label 文字的字体系列*/
        _this.yAxis_axisLabel_textStyle_fontFamily = 'PingFangSC-Regular';
        /** yAxis  label 文字的字体大小*/
        ...
        _this.yAxis_splitLine_lineStyle_color = ['#DDDEE1'];
...
exports.BarPieModel = BarPieModel;
//# sourceMappingURL=BarPie.model.js.map