...
export class BarPieModel extends BaseModel {
    /** backgroundColor  */
    backgroundColor = '#fff';
    echart_color = ['#43A3FB', '#F9D24A', '#FAA449', '#43A3FB'];
    ...
    xAxis_axisLine_show = false;
    /** xAxis  axisLine 坐标轴线线的颜色*/
    xAxis_axisLine_lineStyle_color = '#EBEEF2';
    ...
    xAxis_axisTick_lineStyle_color = "#EBEEF2";
    ...
    xAxis_axisLabel_textStyle_color = "#818596";
    /** xAxis  label 文字的字体系列*/
    ...
    yAxis_axisLabel_align = 'left';
    /** yAxis  label 刻度标签文字的颜色*/
    yAxis_axisLabel_textStyle_color = "#404560";
    /** yAxis  label 文字的字体系列*/
    yAxis_axisLabel_textStyle_fontFamily = 'PingFangSC-Regular';
    /** yAxis  label 文字的字体大小*/
    yAxis_axisLabel_textStyle_fontSize = 12;
    /** yAxis  splitLine 是否显示分隔线*/
    yAxis_splitLine_show = false;
    /** yAxis  splitLine 分隔线颜色，可以设置成单个颜色*/
    yAxis_splitLine_lineStyle_color = ['#DDDEE1'];
