...
//判断当前日期为当年第几周
var getYearWeek = function(a, b, c) { // 年  月  日
    //用d + 当前年的第一天的周差距的和在除以7就是本年第几周
    var date1 = new Date(a, parseInt(b) - 1, c);  //date1是当前日期
    var date2 = new Date(a, 0, 1);  //date2是当年第一天
    var firstWeek = date2.getDay();
    var d = Math.round((date1.valueOf() - date2.valueOf()) / 86400000);  //d是当前日期是今年第多少天
    if(firstWeek == "1"){
        d = Math.round((date1.valueOf() - date2.valueOf()) / 86400000);  //d是当前日期是今年第多少天  358
    }else if(firstWeek == "2"){
        d = Math.round((date1.valueOf() + 86400000 - date2.valueOf()) / 86400000);  //d是当前日期是今年第多少天
    }
    else if(firstWeek == "3"){
        d = Math.round((date1.valueOf() + 86400000*2 - date2.valueOf()) / 86400000);  //d是当前日期是今年第多少天
    }
    else if(firstWeek == "4"){
        d = Math.round((date1.valueOf() + 86400000*3 - date2.valueOf()) / 86400000);  //d是当前日期是今年第多少天
    }
    else if(firstWeek == "5"){
        d = Math.round((date1.valueOf() - 86400000*3 - date2.valueOf()) / 86400000);  //d是当前日期是今年第多少天
    }
