 ...
 */
var RectFunnelModel = (function (_super) {
    __extends(RectFunnelModel, _super);
    function RectFunnelModel() {
        var _this = _super.apply(this, arguments) || this;
        /** backgroundColor  */
        _this.backgroundColor = '#fff';
        _this.color = ['#34508C', '#2B85E4', '#1CB6FB', '#1BDBF5'];
        /** title  */
        /** title 是否显示标题组件  */
    ...
    return RectFunnelModel;
}(model_base_1.BaseModel));
exports.RectFunnelModel = RectFunnelModel;
//# sourceMappingURL=rectFunnel.model.js.map