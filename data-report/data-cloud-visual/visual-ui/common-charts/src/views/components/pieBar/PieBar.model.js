 ...
 */
var PieBarModel = (function (_super) {
    __extends(PieBarModel, _super);
    function PieBarModel() {
        var _this = _super.apply(this, arguments) || this;
        /** backgroundColor  */
        _this.backgroundColor = '#ffffff';
        // color = ['#b71c1c']
        _this.color = ['#43A3FB', '#96D02F', '#F9D24A', '#985FDE', '#ab47bc', '#00acc1', '#ff7043', '#9e9d24', '#5c6bc0', '#00838f', '#c4ccd3'];
        /** title  */
        /** title 是否显示标题组件  */
        ...
        /** legend 图例组件离容器上侧的距离。*/
        _this.legend_top = 'middle'; //'top', 'middle', 'bottom'
        /** legend 图例列表的布局朝向。*/
        ...
        _this.legend_textStyle_color = '#000000';
        ...
        /** series */
        /** series  name*/
        _this.series_name = '价值分类';
        /** series  type*/
        _this.series_type = 'pie';
        /** series  饼图的半径，数组的第一项是内半径，第二项是外半径*/
        _this.series_radius = ['55%', '70%']; // ['50%', '50%']
...
exports.PieBarModel = PieBarModel;
//# sourceMappingURL=PieBar.model.js.map