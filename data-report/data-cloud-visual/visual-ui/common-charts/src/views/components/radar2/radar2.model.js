 ...
 */
var Radar2Model = (function (_super) {
    __extends(Radar2Model, _super);
    function Radar2Model() {
        ...
        /** legend 图例组件离容器上侧的距离。*/
        _this.legend_top = 50; //'top', 'middle', 'bottom'
        /** legend 图例组件离容器右侧的距离。*/
        _this.legend_right = '';
        /** legend 图例组件离容器下侧的距离。*/
        _this.legend_bottom = '';
        ...
        /** series 填充额颜色*/
        _this.series_areaStyle_normal_color = "";
        /** series 图形透明度*/
        _this.series_areaStyle_normal_opacity = '0';
        /** series 是否填充*/
        _this.series_areaStyle_normal_type = 'default';
        /** series data*/
        _this.series_data = [
            {
                value: [''],
        ...
        _this.radar_shape = 'polygon';
        /** radar 的中心（圆心）坐标，数组的第一项是横坐标，第二项是纵坐标。*/
        _this.radar_center = ['40%', '55%'];
        /** radar 的半径，数组的第一项是内半径，第二项是外半径。*/
        _this.radar_radius = 130;
        /** radar 坐标轴刻度标签的相关设置*/
        _this.radar_indicator = [
...
exports.Radar2Model = Radar2Model;
//# sourceMappingURL=radar2.model.js.map