...
var ScatterModel = (function (_super) {
    ...
    function ScatterModel() {
        ...
        _this.indicators = [
            {
                ...
                "list": [
                    ...
                    {
                        "id": "round(sum(visit_cycle)/sum(active_old_users),1)",
                        "name": "到访周期"
                    }
                ]
            }, {
                ...
                "list": [
                    {
                        "id": "ROUND(SUM(active_new_users)/SUM(active_users)*100,1)",
                        "name": "新客占比"
                    },
                    {
                        "id": "ROUND(SUM(active_old_users)/SUM(active_users)*100,1)",
                        "name": "老客占比"
                    },
                    {
                        "id": "ROUND(SUM(high_active_users)/SUM(active_users)*100,1)",
                        "name": "高活跃客占比"
                    },
                    {
                        "id": "ROUND(SUM(middle_active_users)/SUM(active_users)*100,1)",
                        "name": "中活跃客占比"
                    },
                    {
                        "id": "ROUND(SUM(low_active_users)/SUM(active_users)*100,1)",
                        "name": "低活跃客占比"
                    },
                    {
                        "id": "ROUND(SUM(sleep_active_users)/SUM(active_users)*100,1)",
                        "name": "沉睡客占比"
                    }
                ]
            }, {
        ...
        //默认选中的指标
        _this.indicatorX = 'front_users';
        _this.indicatorY = 'front_users';
        _this.indicatorXName = '周边客流';
        _this.indicatorYName = '周边客流';
        /** backgroundColor  */
        ...
        /** xAxis  min*/
        _this.xAxis_min = 'dataMin';
        /** xAxis  max*/
        _this.xAxis_max = 'dataMax';
        /** xAxis  坐标轴两边留白策略*/
        ...
        /** yAxis  min*/
        _this.yAxis_min = 'dataMin';
        /** yAxis  max*/
        _this.yAxis_max = 'dataMax';
