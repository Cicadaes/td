...
export class CityHorizontalBarModel extends BaseModel{
    /** backgroundColor  */
    backgroundColor = '#fff';
    ...
    xAxis_axisLine_lineStyle_color = '#DEE0E3';
    ...
    xAxis_axisLabel_textStyle_color = "#DEE0E3";
    /** xAxis  label 文字的字体系列*/
    ...
    xAxis_splitLine_lineStyle_color = '#DEE0E3';
    ...
    yAxis_axisLine_lineStyle_color = '#DEE0E3';
    ...
    yAxis_splitLine_lineStyle_color = '#5e6679';
