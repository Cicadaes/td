 ...
 */
var StackedBarModel = (function (_super) {
    __extends(StackedBarModel, _super);
    function StackedBarModel() {
        var _this = _super.apply(this, arguments) || this;
        /** backgroundColor  */
        _this.backgroundColor = '#fff';
        _this.echart_color = ['#96D02F', '#F9D24A', '#FAA449', '#43A3FB', '#985FDE', '#1FCE6D'];
        /** title  */
        /** title 是否显示标题组件  */
...
exports.StackedBarModel = StackedBarModel;
//# sourceMappingURL=stackedBar.model.js.map