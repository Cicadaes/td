...
@Component({
    selector: 'tconfig-autocomplete',
    templateUrl: 'tconfig-autocomplete.component.html'
})
export class TconfigAutoCompleteComponent implements OnInit {
    @Input() tconfig: any;
