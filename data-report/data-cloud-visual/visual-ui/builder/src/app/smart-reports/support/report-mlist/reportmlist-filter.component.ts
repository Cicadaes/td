...
@Component({
    selector: 'reportmlist-filter',
    templateUrl: 'reportmlist-filter.component.html',
    styles: [`
      .filter{
            padding: 20px 45px;
            padding-right: 250px;
...
export class ReportmlistFilterComponent implements OnInit {
    ...
    constructor(private communication: DatareportcauseCommunicationService) {
