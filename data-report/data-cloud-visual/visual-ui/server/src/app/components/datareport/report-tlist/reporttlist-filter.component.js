...
var ReporttlistFilterComponent = (function () {
    function ReporttlistFilterComponent(communication) {
    ...
    ReporttlistFilterComponent.prototype.ngOnInit = function () { };
    ReporttlistFilterComponent.prototype.search = function () {
        var _this = this;
        var queryObj = {};
        // 模糊查询的字段统一处理
        var likeParams = ["name"];
    ...
    ReporttlistFilterComponent.prototype.reset = function () {
        this.status = null;
        this.name = null;
    ...
    ReporttlistFilterComponent.prototype.dateFormat = function (date) {
    ...
    return ReporttlistFilterComponent;
}());
ReporttlistFilterComponent = __decorate([
    core_1.Component({
        selector: 'reporttlist-filter',
        templateUrl: 'reporttlist-filter.component.html',
...
exports.ReporttlistFilterComponent = ReporttlistFilterComponent;
//# sourceMappingURL=reporttlist-filter.component.js.map