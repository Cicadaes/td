...
export class AreaModel extends BaseModel{
    ...
    /** yAxis  series 线宽*/
    series_lineStyle_normal_width = 3;
    /** yAxis  series 线的类型*/
    ...
    /** yAxis  series 填充额颜色*/
    series_areaStyle_normal_color = "#43a3fb";
    /** yAxis  series 图形透明度*/
    series_areaStyle_normal_opacity = 0.8;
    /** yAxis  series data*/
    series_0_data = [120, 132, 101, 134, 90, 230, 210];
