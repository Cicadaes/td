...
export class LineModel extends BaseModel{
    ...
    color = ['#EB8E4A','#5AC99E', '#3399FF', '#0f9d58', '#ab47bc','#00acc1',  '#ff7043', '#9e9d24','#5c6bc0', '#00838f', '#c4ccd3'];

    textStyle_color = "#000";
    textStyle_fontFamily = "Microsoft YaHei";
    textStyle_fontSize = 12;
    legend_textStyle_color = "#5e6679";
    ...
    tooltip_formatter = "";
    /* tooltip 类型 */
    tooltip_axisPointer_type = 'cross'; //'line' 直线指示器  'shadow' 阴影指示器  'cross' 十字准星指示器。其实是种简写，表示启用两个正交的轴的 axisPointer。
    /* tooltip 文字颜色 */
    ...
    xAxis_axisLine_lineStyle_color = '#5f6679';
    ...
    xAxis_axisTick_lineStyle_color = "#5f6679";
    ...
    yAxis_axisLine_lineStyle_color = '#5f6679';
