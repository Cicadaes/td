...
export class LineComponent extends BaseComponent {
    ...
    constructor(){
        ...
        let template = new LineTemplate('drf2jh2j5tskbbda');
    ...
    private getSettingObjChange(settingObj:any){
        ...
        let sendObj:Object = Object.assign(
            super.transformInput(settingObj.code,settingObj.result[0].name),
   ...
   public dataChange(data: any): void {
    ...
    protected init(): void{
        ...
        this.myChart = BaseCharts.echarts.init(document.getElementById('drf2jh2j5tskbbda').querySelector("div[commonCharts]") as HTMLDivElement);
        // 绘制图表
    ...
    private commonChange(){
        ...
        $('#drf2jh2j5tskbbda').find('div[commonChange]').click((event:any)=>{
            $("div[commonSelectList]").show();
        });

        $('#drf2jh2j5tskbbda').find('div[commonSelectList]').click((event:any)=>{
            $("div[commonChange]").html(event.target.innerText);

            let sendObj:Object = Object.assign(
                super.transformInput(_self.settingObjCode,event.target.innerText),
