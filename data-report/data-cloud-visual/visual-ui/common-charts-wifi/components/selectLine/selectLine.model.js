...
var SelectLineModel = (function (_super) {
    ...
    function SelectLineModel() {
        ...
        _this.legend_textStyle_color = "#5e6679";
        /** title  */
        /** title 是否显示标题组件  */
        ...
        _this.xAxis_axisLine_lineStyle_color = '#5f6679';
        ...
        _this.xAxis_axisTick_lineStyle_color = "#5f6679";
        ...
        _this.yAxis_axisLine_lineStyle_color = '#5f6679';
