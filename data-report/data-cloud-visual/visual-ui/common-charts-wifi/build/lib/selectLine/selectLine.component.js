...
var SelectedLineComponent = (function (_super) {
    ...
    SelectedLineComponent.prototype.settingChange = function (event, target) {
        var optionList = "";
    ...
    SelectedLineComponent.prototype.getSettingObjChange = function (settingObj) {
        //把第0项放入已选择框里
        $("div[commonChange]").html(settingObj.result[0].name);
        this.settingArrCode = (settingObj.code.split("_"))[0];
        var sendObj = Object.assign(_super.prototype.transformInput.call(this, this.settingArrCode, [_super.prototype.transformInput.call(this, settingObj.code, settingObj.result[0].name)]), _super.prototype.transformInput.call(this, 'oldValue', this.oldValue));
    ...
    SelectedLineComponent.prototype.commonChange = function () {
        ...
        $('#' + this.scopeID).find('div[commonSelectList]').click(function (event) {
            ...
            var sendObj = Object.assign(_super.prototype.transformInput.call(_this, _this.settingArrCode, [_super.prototype.transformInput.call(_this, _self.settingObjCode, event.target.innerText)]), _super.prototype.transformInput.call(_this, 'oldValue', _self.oldValue));
