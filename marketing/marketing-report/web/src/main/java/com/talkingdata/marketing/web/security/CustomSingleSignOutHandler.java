...
public final class CustomSingleSignOutHandler {
    ...
    private String computeRedirectionToServer(final HttpServletRequest request) {
        ...
        if (StringUtils.isNotBlank(relayStateValue)) {
            ...
            if (!this.casServerUrlPrefix.endsWith(serverUrlSuffix)) {
                buffer.append("/");
            }
    ...
    public String safeGetParameter(final HttpServletRequest request, final String parameter,
        ...
        String messsgeTypePost = "POST";
        if (messsgeTypePost.equals(request.getMethod()) && parameters.contains(parameter)) {
