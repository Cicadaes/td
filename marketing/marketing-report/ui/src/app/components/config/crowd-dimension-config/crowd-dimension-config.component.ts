...
@Component({
    selector: 'crowd-dimension-config',
    templateUrl: 'crowd-dimension-config.component.html',
    styleUrls: ['crowd-dimension-config.component.css'],
    providers: [EffectIndexDefinitionResourceService,ConfirmationService,ErrorHandlingService]
})

export class CrowdDimensionConfigComponent {
