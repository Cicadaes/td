...
export class LimitNumberInputDirective {
    ...
    onInput(event: any) {
        ...
        // 根据条件判断正则的值
        switch(condition) {
            case 'I': that.pattern = LimitNumberInputDirective.INTEGER;break;
            case 'PI': that.pattern = LimitNumberInputDirective.POSITIVE_INTEGER;break;
            case 'NI': that.pattern = LimitNumberInputDirective.NEGATIVE_INTEGER;break;
            case 'FP': that.pattern = LimitNumberInputDirective.FLOATING_POINT;break;
            case 'PFP': that.pattern = LimitNumberInputDirective.POSITIVE_FLOATING_POINT;break;
            case 'NFP': that.pattern = LimitNumberInputDirective.NEGATIVE_FLOATING_POINT;break;
            default: that.pattern = LimitNumberInputDirective.UNUSEFUL_REGZEP;break;
        }
