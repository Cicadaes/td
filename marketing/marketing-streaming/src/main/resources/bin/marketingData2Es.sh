...
nohup ${SPARK_HOME}/bin/spark-submit \
             --class com.talkingdata.marketing.streaming.MarketingData2Es \
             ...
             ${libs_dir}/marketing-streaming.jar \
             -dt eventpackage > marketingData2Es.log &

echo $! > ${APP_HOME}/marketingData2Es.pid