...
public class DateUtil {
    ...
    public static void main(String[] args) {
        LocalDateTime localDateTime = parseDateTime("2017/09/22 12:22:33", dtf_y4mmdd_hhmmss);
        System.out.println(localDateTime);
        LocalDateTime plusLocalDateTime = plus(localDateTime, ChronoUnit.DAYS, 3);
        System.out.println(plusLocalDateTime);
        System.out.println(!LocalDateTime.now().isAfter(plusLocalDateTime));
