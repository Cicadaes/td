...
//        webPath = (new StringBuilder(String.valueOf(webPath))).append(entityPackage).append("\\").toString();
        ...
        if (!"true".equals(CodeResourceUtil.MAPPER_XML_ONLY)) {
        ...
        if (!"true".equals(CodeResourceUtil.BACKEND_ONLY)) {
            ...
            if ("form".equals(CodeResourceUtil.ENTITY_OPEN_TYPE)) {
            ...
            else if ("dialog".equals(CodeResourceUtil.ENTITY_OPEN_TYPE)) {
