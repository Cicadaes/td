...
public class CodeResourceUtil {
    ...
    public static String bizClientPackage;
    public static String bizPackageUrl;
    public static String bizClientPackageUrl;
    ...
    public static String getBizClientPackage() {
        return bundlePath.getString("biz_client_package");
    }
    ...
    static {
        ...
        bizClientPackage = getBizClientPackage();
        bizClientPackageUrl = bizClientPackage.replace(".", "/");
