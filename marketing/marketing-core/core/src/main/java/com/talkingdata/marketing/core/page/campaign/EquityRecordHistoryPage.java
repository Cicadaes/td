...
/**
 * <b>功能：</b>TD_MKT_EQUITY_RECORD_HISTORY EquityRecordHistoryPage<br>
 * <b>@author：</b>code generator<br>
 * <b>日期：</b> 2017-09-19 <br>
 * <b>版权所有：<b>Copyright(C) 2015, Beijing TendCloud Science & Technology Co., Ltd.<br>
 */
public class EquityRecordHistoryPage extends BasePage {
    ...
    private String pipelineDefinitionIdOperator = "=";
    private String equityConfigId;
    private String equityConfigIdOperator = "=";
    private String equityCode;
    private String equityCodeOperator = "=";
    private String equityValue;
    private String equityValueOperator = "=";
    ...
    public String getPipelineDefinitionIdOperator() {
        return this.pipelineDefinitionIdOperator;
    }

    public void setPipelineDefinitionIdOperator(String pipelineDefinitionIdOperator) {
        this.pipelineDefinitionIdOperator = pipelineDefinitionIdOperator;
    }

    public String getEquityConfigId() {
        return this.equityConfigId;
    }

    public void setEquityConfigId(String equityConfigId) {
        this.equityConfigId = equityConfigId;
    }

    public String getEquityConfigIdOperator() {
        return this.equityConfigIdOperator;
    }

    public void setEquityConfigIdOperator(String equityConfigIdOperator) {
        this.equityConfigIdOperator = equityConfigIdOperator;
    }
    ...
    public String getEquityCodeOperator() {
        return this.equityCodeOperator;
    }

    public void setEquityCodeOperator(String equityCodeOperator) {
        this.equityCodeOperator = equityCodeOperator;
    }
    ...
    public String getEquityValueOperator() {
        return this.equityValueOperator;
    }

    public void setEquityValueOperator(String equityValueOperator) {
        this.equityValueOperator = equityValueOperator;
    }
