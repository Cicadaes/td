...
/**
 * <b>功能：</b>TD_MKT_FUNNEL_STEP_DEFINITION FunnelStepDefinitionEntity<br>
 * <b>@author：</b>code generator<br>
 * <b>日期：</b> 2017-04-26 <br>
 * <b>版权所有：<b>Copyright(C) 2015, Beijing TendCloud Science & Technology Co., Ltd.<br>
 */
public class FunnelStepDefinition extends BaseEntity {
     ...
     * <p>字段列表：</p>
     * <li>id -> id</li>
     * <li>funnelDefinitionId -> funnel_definition_id</li>
     * <li>name -> name</li>
     * <li>type -> type</li>
    ...
    public static String fieldToColumn(String fieldName) {
        ...
        switch (fieldName) {
            case "id": return "id";
            case "funnelDefinitionId": return "funnel_definition_id";
     ...
     * <p>字段列表：</p>
     * <li>id -> id</li>
     * <li>funnel_definition_id -> funnelDefinitionId</li>
     * <li>name -> name</li>
     * <li>type -> type</li>
    ...
    public static String columnToField(String columnName) {
        ...
        switch (columnName) {
            case "id": return "id";
            case "funnel_definition_id": return "funnelDefinitionId";
            case "name": return "name";
            case "type": return "type";
    ...
    public Integer getFunnelDefinitionId() {
        return this.funnelDefinitionId;
    }
