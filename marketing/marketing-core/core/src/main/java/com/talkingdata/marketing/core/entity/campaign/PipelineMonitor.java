 ...
 * <b>日期：</b> 2018-03-10 <br>
 * <b>版权所有：<b>Copyright(C) 2015, Beijing TendCloud Science & Technology Co., Ltd.<br>
 */
public class PipelineMonitor extends BaseEntity {
    ...
    public static String fieldToColumn(String fieldName) {
        ...
        switch (fieldName) {
            ...
            case "monitorType": return "monitor_type";
            case "metricValue": return "metric_value";
    ...
    public static String columnToField(String columnName) {
        ...
        switch (columnName) {
            ...
            case "monitor_type": return "monitorType";
            case "metric_value": return "metricValue";
