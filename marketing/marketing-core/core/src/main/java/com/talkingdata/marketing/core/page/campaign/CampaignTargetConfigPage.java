...
/**
 * <b>功能：</b>TD_MKT_CAMPAIGN_TARGET_CONFIG CampaignTargetConfigPage<br>
 * <b>@author：</b>code generator<br>
 * <b>日期：</b> 2017-09-27 <br>
 * <b>版权所有：<b>Copyright(C) 2015, Beijing TendCloud Science & Technology Co., Ltd.<br>
 */
public class CampaignTargetConfigPage extends BasePage {
    ...
    private String targetDefinitionIdOperator = "=";
    private String targetDefinitionCode;
    private String targetDefinitionCodeOperator = "=";
    private String name;
    private String nameOperator = "=";
    private String value;
    private String valueOperator = "=";
    private String metricType;
    private String metricTypeOperator = "=";
    ...
    public String getTargetDefinitionIdOperator() {
        return this.targetDefinitionIdOperator;
    }

    public void setTargetDefinitionIdOperator(String targetDefinitionIdOperator) {
        this.targetDefinitionIdOperator = targetDefinitionIdOperator;
    }
    ...
    public String getTargetDefinitionCodeOperator() {
        return this.targetDefinitionCodeOperator;
    }

    public void setTargetDefinitionCodeOperator(String targetDefinitionCodeOperator) {
        this.targetDefinitionCodeOperator = targetDefinitionCodeOperator;
    }
    ...
    public String getMetricTypeOperator() {
        return this.metricTypeOperator;
    }

    public void setMetricTypeOperator(String metricTypeOperator) {
        this.metricTypeOperator = metricTypeOperator;
    }
