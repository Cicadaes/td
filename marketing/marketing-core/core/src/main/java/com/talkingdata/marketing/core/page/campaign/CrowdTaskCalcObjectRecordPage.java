...
/**
 * <b>功能：</b>TD_MKT_CROWD_TASK_CALC_OBJECT_RECORD CrowdTaskCalcObjectRecordPage<br>
 * <b>@author：</b>code generator<br>
 * <b>日期：</b> 2018-02-26 <br>
 * <b>版权所有：<b>Copyright(C) 2015, Beijing TendCloud Science & Technology Co., Ltd.<br>
 */
public class CrowdTaskCalcObjectRecordPage extends BasePage {
    ...
    private String crowdNameOperator = "=";
    private String crowdType;
    private String crowdTypeOperator = "=";
    ...
    private String errorInfoOperator = "=";
    ...
    private String refIdOperator = "=";
    private String retry;
    private String retryOperator = "=";
    private String maxRetry;
    private String maxRetryOperator = "=";
    ...
    public String getCrowdNameOperator() {
        return this.crowdNameOperator;
    }

    public void setCrowdNameOperator(String crowdNameOperator) {
        this.crowdNameOperator = crowdNameOperator;
    }
    ...
    public String getCrowdTypeOperator() {
        return this.crowdTypeOperator;
    }

    public void setCrowdTypeOperator(String crowdTypeOperator) {
        this.crowdTypeOperator = crowdTypeOperator;
    }
    ...
    public String getErrorInfoOperator() {
        return this.errorInfoOperator;
    }

    public void setErrorInfoOperator(String errorInfoOperator) {
        this.errorInfoOperator = errorInfoOperator;
    }
    ...
    public String getRefIdOperator() {
        return this.refIdOperator;
    }

    public void setRefIdOperator(String refIdOperator) {
        this.refIdOperator = refIdOperator;
    }
    ...
    public String getRetryOperator() {
        return this.retryOperator;
    }

    public void setRetryOperator(String retryOperator) {
    ...
    public String getMaxRetryOperator() {
        return this.maxRetryOperator;
    }

    public void setMaxRetryOperator(String maxRetryOperator) {
        this.maxRetryOperator = maxRetryOperator;
    }
