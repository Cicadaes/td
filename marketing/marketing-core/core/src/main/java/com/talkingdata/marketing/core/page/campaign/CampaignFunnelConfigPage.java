...
/**
 * <b>功能：</b>TD_MKT_CAMPAIGN_FUNNEL_CONFIG CampaignFunnelConfigPage<br>
 * <b>@author：</b>code generator<br>
 * <b>日期：</b> 2017-05-04 <br>
 * <b>版权所有：<b>Copyright(C) 2015, Beijing TendCloud Science & Technology Co., Ltd.<br>
 */
public class CampaignFunnelConfigPage extends BasePage {
    ...
    private String funnelIdOperator = "=";
    private String funnelName;
    private String funnelNameOperator = "=";
    private String defaultFlag;
    private String defaultFlagOperator = "=";
    ...
    public String getFunnelIdOperator() {
        return this.funnelIdOperator;
    }

    public void setFunnelIdOperator(String funnelIdOperator) {
        this.funnelIdOperator = funnelIdOperator;
    }
    ...
    public String getFunnelNameOperator() {
        return this.funnelNameOperator;
    }

    public void setFunnelNameOperator(String funnelNameOperator) {
        this.funnelNameOperator = funnelNameOperator;
    }
    ...
    public String getDefaultFlagOperator() {
        return this.defaultFlagOperator;
    }

    public void setDefaultFlagOperator(String defaultFlagOperator) {
        this.defaultFlagOperator = defaultFlagOperator;
    }
